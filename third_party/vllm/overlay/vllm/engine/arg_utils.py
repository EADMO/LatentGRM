...
class EngineArgs:
    ...
    enable_latent: bool = ModelConfig.enable_latent
    latent_end_token_id: int | None = ModelConfig.latent_end_token_id
    latent_topk: int = ModelConfig.latent_topk
    ...
    def create_model_config(self) -> ModelConfig:
        ...
        return ModelConfig(
            ...
            enable_latent=self.enable_latent,
